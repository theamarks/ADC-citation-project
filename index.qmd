...
#| code-fold: true
#| fig-cap: "Number of citations found in one or more sources"
...
if(file.exists(path_overlap)){
  ...
  write_csv(scythe_overlap_sum, file.path(path_overlap), row.names = F)
}
