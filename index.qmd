...
overlap_color <- c("#B5E1E7", "#19B36A", "#1B897E", "#7AFDB1")
...
# academic discipline ontology fit to ADC datasets and scythe citaitons
...
```{r treemap_figure, eval=F}
#| code-fold: true

# These are not great at displaying more than 2 groupings. The ontology data has at most 5

# data prep for treemaps & sunburst figures
source(file.path("./R/treemap.R"))
...
# all levels - hydrology broken into indvidual leaves
sun_all <- sunburst(sun_levels_all, legend=FALSE)
sun_all

# next - put hydrology back into original heirarchtical structure
